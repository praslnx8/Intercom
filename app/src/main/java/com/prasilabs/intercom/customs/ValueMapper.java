...
import com.prasilabs.intercom.annotions.DB;
...
public class ValueMapper
{
    ...
    public static ArrayMap<String, Object> bundleToParams(Bundle bundle)
    {
    ...
    public static ContentValues mapObjectToContentValues(ContentValues contentValues, Object object)
    {
        ...
        for (String key : objectArrayMap.keySet())
        {
            ...
            try
            {
                if(field != null && field.isAnnotationPresent(DB.class))
                {
    ...
    {
        if(field != null && cursor != null && field.isAnnotationPresent(DB.class))
        {
            try
            {
