package com.prasilabs.intercom.services.crashReport;
...
import com.prasilabs.intercom.activities.SorryCrashActivity;
...
public class NoCrashHandler {
    ...
    /**
     * Deprecated cause of loop warning. logging the exception call back it..
     * @param e
     */
    @Deprecated
    private static void sendExceptionReportReport(Exception e) {
        String stackTrace = getErrorMessage(e);

        if (CoreApp.getAppContext() != null) {
            LocalPreference.saveAppDataInShared(CoreApp.getAppContext(), CommonConstant.CRASH_STACKTRACE_STR, stackTrace);
        }
